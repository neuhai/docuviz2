...
// Import necessary modules using importScripts
importScripts(
  'lib/underscore.js',
  'lib/async.js',
  'lib/d3.min.js'
...
chrome.runtime.onMessage.addListener((request, sender, sendResponse) => {
    switch (request.msg) {
        ...
        case 'changelog':
            docuviz.buildRevisions(request.vizType, request.docId, request.changelog, request.authors, request.revTimestamps, request.revAuthors);
            break;
        case 'setToken':
